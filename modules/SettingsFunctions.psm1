...
function RenderEditGameForm($GamesList) {
    ...
    $buttonRemove.Size = New-Object System.Drawing.Size(75, 23)
    $buttonRemove.BackColor = [System.Drawing.Color]::Firebrick
    $buttonRemove.ForeColor = [System.Drawing.Color]::White
    $buttonRemove.FlatStyle = 'flat'
    $buttonRemove.FlatAppearance.BorderSize = 0
    $buttonRemove.FlatAppearance.MouseOverBackColor = [System.Drawing.Color]::DarkRed
...
function RenderProfileSettingsForm() {
    ...
    $labelProfile1 = Createlabel "Profile 1:" 20 20
    $profileSettingsForm.Controls.Add($labelProfile1)
    $textProfile1 = CreateTextBox $profiles[0].name 100 20 150 20
    $profileSettingsForm.Controls.Add($textProfile1)

    $labelProfile2 = Createlabel "Profile 2:" 20 60
    $profileSettingsForm.Controls.Add($labelProfile2)
    $textProfile2 = CreateTextBox $profiles[1].name 100 60 150 20
    $profileSettingsForm.Controls.Add($textProfile2)

    $buttonOK = CreateButton "OK" 70 110
    $buttonOK.Add_Click({
        Update-ProfileName -ProfileId 1 -ProfileName $textProfile1.Text
        Update-ProfileName -ProfileId 2 -ProfileName $textProfile2.Text
        ShowMessage "Profile names updated successfully." "OK" "Information"
        $profileSettingsForm.Close()
    })
    $profileSettingsForm.Controls.Add($buttonOK)

    $buttonCancel = CreateButton "Cancel" 150 110
    $buttonCancel.Add_Click({
        $profileSettingsForm.Close()
    })
    $profileSettingsForm.Controls.Add($buttonCancel)

    $profileSettingsForm.ShowDialog()
    $profileSettingsForm.Dispose()
}
